 ...
 *
 * Original CDP path was chrome://remote/content/cdp/observers/ChannelEventSink.jsm
 * but Mozilla removed the CDP implementation from Firefox starting with 141
 * (https://fxdx.dev/cdp-retirement-in-firefox/). This module is the local
 * replacement so juggler can keep observing channel redirects.
 */
