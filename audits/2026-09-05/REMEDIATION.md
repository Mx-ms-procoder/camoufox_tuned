...
Playwright **1.62.0**. Vollständige Builds und Laufzeitprüfungen dieses neuen
Browsers sind vor Veröffentlichung noch erforderlich.
...
| 3 | RLBox-Ausschluss entfernt; Mozilla-Bootstrap einschließlich WASI auch für Linux aktiviert. | Build-Konfiguration korrigiert; Sandbox-Bestandteile im fertigen Build prüfen. |
...
| 17 | DOM-Auswertung repariert, native WebDriver-Property-Form erwartet; offizieller Firefox lässt sich ohne Juggler erfassen. Optionaler strenger Baseline-Check. | Historische FF150-Baseline weiterhin partiell, bis echte neue Messung vorliegt. Kein vollständiger Paritätsnachweis durch übersprungene Felder. |
